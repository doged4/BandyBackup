...
fullMainArray = pickle.load( open( "/home/cevbain/TrumpPostFULLFinal.p", "rb" ) )
...
def save_imgs(generator, epoch):
   ...
   # noise = np.random.normal(0, 1, noise_len).reshape(100,)
    ...
    pickle.dump( gen_img, open("SuperNowTest/"+(str(epoch) + ".p"), "wb" ) )
...
train(generator, discriminator, combined, epochs=10000010, batch_size=32, save_interval=100000)
